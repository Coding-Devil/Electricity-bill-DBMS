...
public class Signup extends JFrame implements ActionListener{
    ...
    if (ae.getSource() == create) {
        ...
        String susername = username.getText().trim(); // Use trim() to remove leading and trailing whitespaces
        String sname = name.getText().trim();
        String spassword = password.getText().trim();
        String smeter = meter.getText().trim();

        // Check for empty fields. Add or modify the conditions according to your requirements.
        if (susername.isEmpty() || spassword.isEmpty() || (atype.equals("Customer") && smeter.isEmpty()) || sname.isEmpty()) {
        ...
        try {
            ...
            if (atype.equals("Admin")) {
                ...
                // Assuming 'user' should be 'user_type' based on your table structure
